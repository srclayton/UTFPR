...
void executar(long int input){
    ...
    {
        if(tamanho_num < 13)
        printf("%ld Numero muito curto", input);
        else
        printf("%ld Numero muito grande", input);
    }
    else
    {
            ...
            if(tamanho_num == 13){
                ...
                if(operadora == 30 || operadora == 36 || operadora == 38){
                    if(valid_num == 1)
                        ...
                        printf("%ld, Diners, invalido", input);
                }
                else
                printf("%ld Operadora desconhecida", input);
            }
                ...
                if(operadora == 34 || operadora == 37){
                     if(valid_num == 1)
                        printf("%ld, Amex, válido", input);
                    else
                        printf("%ld, Amex, invalido", input);
                }
                else if(operadora == 2014 || operadora == 2149){
                    if(valid_num == 1)
                        printf("%ld, enRoute, válido", input);
                    else
                        printf("%ld, enRoute, invalido", input);
                }
                else if(operadora == 2131 || operadora == 1800){
                    if(valid_num == 1)
                        printf("%ld, JCB, válido", input);
                    else
                ...
                if(operadora >= 51 && operadora <= 55){
                    if(valid_num == 1)
                        printf("%ld, Mastercard, válido", input);
                    else
                        printf("%ld, Mastercard, invalido", input);
                }
                else if(operadora == 4){
                    if(valid_num == 1)
                        printf("%ld, Visa, válido", input);
                    ...
                    if(valid_num == 1)
                        printf("%ld, Discover, válido", input);
                    else
                        printf("%ld, Discover, invalido", input);
                }
                else if(operadora == 3){
                    if(valid_num == 1)
                        printf("%ld, JCB, válido", input);
